                            ...
                            {foreach from=$doctors item=doctor}
                                <tr>
                                    <td class="photo-column">
                                        {if $doctor.photo}
                                            <img src="/controllers/doctor/mostrar_foto.php?id={$doctor.id}" alt="Foto del médico" style="width: 50px; height: 50px; object-fit: cover; border-radius: 50%;">
                                        {else}
                                            <p>Sin foto</p>
                                        {/if}
                                    </td>
                                    ...
                                    <td class="actions-td">
                                        <form action="/controllers/doctor/delete-doctor.controller.php" method="POST" class="action-wrapper">
                                            ...
                                            <input type="hidden" name="doctor_names" value="{$doctor.names} {$doctor.last_name} {$doctor.last_name2}">
