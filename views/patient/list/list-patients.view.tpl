                        ...
                        if (addPatientBtn) {
                            addPatientBtn.addEventListener('click', function(e) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = "/views/patient/register/register-patient.view.php?form_type=" + formType;
                                });
                            });
                        }
                    });
                        ...
                        {if $patients|@count > 0}
                            {foreach from=$patients item=patient}
                                ...
                                <td class="photo-column">
                                    ...
                                    <td data-label="Sexo">
                                        {if $patient.gender == 'M'}Masculino
                                        {elseif $patient.gender == 'F'}Femenino
                                        {else}{$patient.gender|escape}
                                        {/if}
                                    </td>
                                    <td class="actions-td">
                                        ...
                                        <a href="/views/patient/profile/patient-profile.view.php?id={$patient.id}" class="action-wrapper">
