...
" alt="Foto del paciente" style="width: 50px; height: 50px; object-fit: cover; border-radius: 50%;">
 ...
 <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('patient')['last_name2'], ENT_QUOTES, 'UTF-8', true);?>
                                    ...
                                    <td data-label="Sexo">
                                        <?php if ($_smarty_tpl->getValue('patient')['gender'] == 'M') {?>Masculino
                                        <?php } elseif ($_smarty_tpl->getValue('patient')['gender'] == 'F') {?>Femenino
                                        <?php } else {
echo htmlspecialchars((string)$_smarty_tpl->getValue('patient')['gender'], ENT_QUOTES, 'UTF-8', true);?>
