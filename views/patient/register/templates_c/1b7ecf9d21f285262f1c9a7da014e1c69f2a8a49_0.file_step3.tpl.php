<?php
/* Smarty version 5.4.5, created on 2025-05-15 02:25:26
  from 'file:steps/step3.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.5',
  'unifunc' => 'content_6825509626b929_80117989',
...
function content_6825509626b929_80117989 (\Smarty\Template $_smarty_tpl) {
...
?><div class="form-step" id="step-3" style="display: none;">
    <div class="form-group">
        ...
        <select id="bloodType" name="blood_type" required>
            ...
            <option value="A+" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'A+') {?>selected<?php }?>>A+</option>
            <option value="A-" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'A-') {?>selected<?php }?>>A-</option>
            <option value="B+" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'B+') {?>selected<?php }?>>B+</option>
            <option value="B-" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'B-') {?>selected<?php }?>>B-</option>
            <option value="AB+" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'AB+') {?>selected<?php }?>>AB+</option>
            <option value="AB-" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'AB-') {?>selected<?php }?>>AB-</option>
            <option value="O+" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'O+') {?>selected<?php }?>>O+</option>
            <option value="O-" <?php if ($_smarty_tpl->getValue('patient')['blood_type'] == 'O-') {?>selected<?php }?>>O-</option>
        </select>
    </div>
    <div class="form-group">
