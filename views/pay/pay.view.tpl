        ...
        <div class="payment-box">
            ...
            <form action="/controllers/pay/pay.controller.php" method="POST" id="payment-form">
                ...
                <label class="option">
                    ...
                    Pago en Efectivo <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor"
                ...
                <label class="option">
                    ...
                    PayPal <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor"
